...
<div class="top-search-area">
    <?php get_template_part('template-parts/search/main-search-hourly'); ?>
</div>
        ...
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                if ($listing_qry->have_posts()):
                    $listing_founds = $listing_qry->found_posts; ?>
                        ...
                        if ($pagination_type == 'number') {
                            homey_pagination($listing_qry->max_num_pages, $range = 2);
                                ...
                                <div class="homey-loadmore loadmore text-center">
                                    <a data-paged="2" data-limit="<?php echo esc_attr($posts_per_page); ?>" data-style="grid"
                                        ...
                                        data-booking_type="<?php echo esc_attr($booking_type); ?>" data-featured="" data-offset=""
                                        data-sortby="<?php echo esc_attr($sort_by); ?>" href="#" class="btn btn-primary btn-short">

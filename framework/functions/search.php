...
if( !function_exists('homey_listing_search') ) {
    function homey_listing_search($search_query)
    {
		...
		$sleeping_accommodation_search = isset($_GET['sleeping_accommodation_search']) ? $_GET['sleeping_accommodation_search'] : '';
		$guided_services_search = isset($_GET['guided_services_search']) ? $_GET['guided_services_search'] : '';
		$search_keyword = isset($_GET['search_keyword']) ? sanitize_text_field($_GET['search_keyword']) : '';
		$featured_listings_only = isset($_GET['featured_listings_only']) ? $_GET['featured_listings_only'] : '';
		$allowed_pets_listings = isset($_GET['allowed_pets_listings']) ? $_GET['allowed_pets_listings'] : '';
		$allowed_parties_listings = isset($_GET['allowed_parties_listings']) ? $_GET['allowed_parties_listings'] : '';
		$allowed_cancellations_listings = isset($_GET['allowed_cancellations_listings']) ? $_GET['allowed_cancellations_listings'] : '';
...
//        $pets = $pets == '' ? 1 : $pets;
        ...
        if (!empty($lat) && !empty($lng)) {
            $meta_query[] = array(
			array(
                'key' => 'homey_geolocation_lat',
                'value' => $lat,				
                'compare' => '=',
            ),

            array(
                'key' => 'homey_geolocation_long',
                'value' => $lng,
                'compare' => '=',
            ),
			);
	    ...
	    if ( !empty($sleeping_accommodation_search) ) {
            $meta_query[] = array(
                'key' => 'have_sleeping_accomodations',
                'value' => $sleeping_accommodation_search,				
                'compare' => '=',
			);
        }
		
		if ( !empty($guided_services_search) ) {
            $meta_query[] = array(
                'key' => 'have_guided_service',
                'value' => $guided_services_search,				
                'compare' => '=',
			);
        }
		
		if (!empty($featured_listings_only) && $featured_listings_only == '1') {
            $meta_query[] = array(
            'key' => 'homey_featured',
            'value' => '1',
            'compare' => '=',
		...
		if (!empty($allowed_pets_listings) && $allowed_pets_listings == '1') {
            $meta_query[] = array(
            'key' => 'homey_pets',
            'value' => '1',
            'compare' => '=',
		...
		if (!empty($allowed_parties_listings) && $allowed_parties_listings == '1') {
            $meta_query[] = array(
            'key' => 'homey_party',
            'value' => '1',
            'compare' => '=',
		...
		if (!empty($allowed_cancellations_listings) && $allowed_cancellations_listings == '1') {
            $meta_query[] = array(
            'key' => 'select_cancellation',

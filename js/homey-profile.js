  ...
  if (typeof homeyProfile !== "undefined") {
    ...
    $("#btn_verify_id").on("click", function (e) {
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data.success) {
            jQuery("#id_verify_mgs")
              .empty()
              .append(
                '<div class="alert alert-success alert-dismissible" role="alert"><button type="button" class="close" data-hide="alert" aria-label="Close"></button>' +
                  data.msg +
                  "</div>"
              );
            ...
            jQuery("#id_verify_mgs")
              .empty()
              .append(
                '<div class="alert alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-hide="alert" aria-label="Close"></button>' +
                  data.msg +
                  "</div>"
              );
          }
    ...
    $(".homey_profile_save").on("click", function (e) {
      ...
      var firstname = $("#firstname").val(),
        firstname_guest = $("#firstname_guest").val(),
        lastname_guest = $("#lastname_guest").val(),
        lastname = $("#lastname").val(),
        display_name_public = $("#display_name_public").val(),
        display_name_public_guest = $("#display_name_public_guest").val(),
        ...
        native_language_guest = $("#native_language_guest").val(),
        other_language_guest = $("#other_language_guest").val(),
        phone_number = $("#phone_number").val(),
        phone_number_guest = $("#phone_number_guest").val(),
        bio = $("#bio").val(),
        bio_guest = $("#bio_guest").val(),
        ...
        country = $("#country").val(),
        street_address_guest = $("#street_address_guest").val(),
        apt_suit_guest = $("#apt_suit_guest").val(),
        city_guest = $("#city_guest").val(),
        state_guest = $("#state_guest").val(),
        zipcode_guest = $("#zipcode_guest").val(),
        neighborhood_guest = $("#neighborhood_guest").val(),
        country_guest = $("#country_guest").val(),
        work_place = $("#work_place").val(),
        work_place_guest = $("#work_place_guest").val(),
        ...
        em_contact_name_guest = $("#em_contact_name_guest").val(),
        em_relationship_guest = $("#em_relationship_guest").val(),
        em_email_guest = $("#em_email_guest").val(),
        em_phone_guest = $("#em_phone_guest").val(),
      ...
      $.ajax({
        ...
        data: {
          ...
          firstname: firstname,
          firstname_guest: firstname_guest,
          lastname: lastname,
          lastname_guest: lastname_guest,
          display_name_public: display_name_public,
          display_name_public_guest: display_name_public_guest,
          work_place: work_place,
          work_place_guest: work_place_guest,
          useremail: useremail,
          ...
          bio: bio,
          native_language_guest: native_language_guest,
          other_language_guest: other_language_guest,
          phone_number_guest: phone_number_guest,
          bio_guest: bio_guest,
          ...
          country: country,
          street_address_guest: street_address_guest,
          apt_suit_guest: apt_suit_guest,
          city_guest: city_guest,
          state_guest: state_guest,
          zipcode_guest: zipcode_guest,
          neighborhood_guest: neighborhood_guest,
          ...
          em_email: em_email,
          em_phone: em_phone,
          em_contact_name_guest: em_contact_name_guest,
          em_relationship_guest: em_relationship_guest,
          em_email_guest: em_email_guest,
          em_phone_guest: em_phone_guest,
    ...
    var profile_processing_modal = function (msg) {
      var process_modal =
        '<div class="modal fade" id="fave_modal" tabindex="-1" role="dialog" aria-labelledby="faveModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-body homey_messages_modal">' +
        msg +
        "</div></div></div></div></div>";
    ...
    var homey_plupload = new plupload.Uploader({
      ...
      url:
        ajaxURL +
        "?action=homey_user_picture_upload&verify_nonce=" +
        homey_upload_nonce +
        "&user_id=" +
        user_id,
      filters: {
    ...
    homey_plupload.bind("FilesAdded", function (up, files) {
      ...
      document.getElementById("homey_profile_photo").innerHTML =
        homey_thumbnail;
      up.refresh();
    ...
    homey_plupload.bind("Error", function (up, err) {
      document.getElementById("upload_errors").innerHTML +=
    ...
    var homey_doc_plupload = new plupload.Uploader({
      ...
      url:
        ajaxURL +
        "?action=homey_user_document_upload&verify_nonce=" +
        homey_upload_nonce +
        "&user_id=" +
        user_id,
      filters: {
    ...
    homey_doc_plupload.bind("FileUploaded", function (up, file, ajax_res) {
      ...
      if (response.success) {
        var homey_profile_thumb =
          ...
          response.url +
          '" alt="" />' +
          '<input type="hidden" class="profile-doc-id" id="profile-doc-id" name="profile-doc-id" value="' +
          response.attachment_id +
          '"/>';

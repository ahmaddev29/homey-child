        ...
        <div class="block-bordered">
            ...
            <?php if ($hide_labels['sn_accom_label'] != 1 && $guests != '') { ?>
                <div class="block-col block-col-25">
                    ...
                    <div><strong><?php echo esc_attr($guests) . ' > ' . $num_additional_guests; ?>
                            <?php echo esc_attr(homey_option('sn_guests_label')); ?></strong></div>
                </div>
            <?php } ?>
            ...
            <?php if ($hide_labels['sn_bedrooms_label'] != 1 && $bedrooms != '') { ?>
                <div class="block-col block-col-25">
                    ...
                    <div><strong><?php echo esc_attr($bedrooms); ?> <?php echo esc_attr(homey_option('sn_bedrooms_label')); ?> /
                            <?php echo esc_attr($beds); ?> <?php echo esc_attr(homey_option('sn_beds_label')); ?></strong></div>
                </div>
            <?php } ?>

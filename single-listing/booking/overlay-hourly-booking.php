			...
			<div class="sidebar-booking-module-body">
				<div class="homey_notification search-wrap search-banner">
					...
					<div class="search-message">
						<textarea name="guest_message" class="form-control" rows="3" placeholder="<?php echo esc_html__('What is your reason for booking this adventure?', 'homey'); ?>"></textarea>
					</div>
					<?php //} 
					?>
...
<div class="overlay-booking-btn" style="display:none">
	<div class="pull-left">

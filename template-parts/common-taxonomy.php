...
if ($taxonomy_sidebar == 'no-sidebar') {
    ...
    $content_classes = 'col-xs-12 col-sm-12 col-md-8 col-lg-12';
...
$state_args = array(
    ...
    'tax_query' => array(
        array(
            ...
            'terms' => strtolower($ip_array->regionName),
            'field' => 'slug',
            'operator' => 'IN'
        )
    ),
...
$state_query = new WP_Query($state_args);
$state_query_count = $state_query->post_count;
...
$featured_args['meta_key'] = 'homey_featured';
$featured_args['meta_value'] = '1';

$featured_query = new WP_Query($featured_args);
$featured_query_count = $featured_query->post_count;
?>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="page-title">
                    <div class="block-top-title">
						...
						<h1 class="listing-title" style="margin: 0 0 15px !important;"><?php echo single_cat_title(); ?></h1>
						<?php if (0 == $post_count) : ?>
                            <h4 class="listing-title">No listing found for <?php echo single_cat_title(); ?>! But here are some other awesome Backyard Lease suggestions:</h4>
                        <?php else : ?>
                        <h4 class="listing-title">
                            <?php echo $post_count; ?> listings found for <?php echo single_cat_title(); ?>
                        </h4>
						<?php endif; ?>
                    </div><!-- block-top-title -->
                </div><!-- page-title -->
        ...
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <?php if ($wp_query->have_posts()) : $listing_founds = $wp_query->found_posts; ?>
                    ...
                    <div class="listing-wrap item-<?php echo esc_attr($taxonomy_layout); ?>-view">
                        ...
                        <!--start Pagination-->
                        <?php homey_pagination($wp_query->max_num_pages, $range = 2);
                        wp_reset_postdata(); ?>
                        <!--start Pagination-->
						<?php wp_reset_query(); ?>
                    </div><!-- listing-wrap -->
                    ...
                    // Display all listings when no search results are found
                            ...
                            <div class="row">
                                ...
                                while ($all_listings_query->have_posts()) : $all_listings_query->the_post();
                                    ...
                                    if ($search_layout == 'card') {
                                        ...
                                        get_template_part('template-parts/listing/listing-noitem');
                                    }
                                endwhile;
                                ?>
                            </div>
							<!-- <?php homey_pagination($all_listings_query->max_num_pages, $range = 2); ?> -->
                        </div><!-- listing-wrap -->
            ...
            <?php if ($taxonomy_sidebar != 'no-sidebar') { ?>
                <div class="<?php echo esc_attr($sidebar_classes);
                            if (@$sticky_sidebar['listing_sidebar'] != 0) {
                                echo ' homey_sticky';
                            } ?>">

...
<div class="homey-extra-prices">
    ...
    <p>Enter optional add-ons that your guests can purchase beyond your listing price. Ex: Grill Rental $45.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="extra_price[<?php echo esc_attr($count - 1); ?>][price]" value="<?php echo sanitize_text_field($service['price']); ?>" class="form-control" placeholder="<?php echo esc_attr($homey_local['ex_price_plac']); ?>">
                            </div>
                        </div>
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">

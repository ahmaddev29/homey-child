...
$subcategory = get_field('field_6479eb70249d7', $listing_data->ID);
?>
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-xs-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="sub_cat_type" placeholder="Enter Subcategory" value="<?php echo esc_html($subcategory); ?>">

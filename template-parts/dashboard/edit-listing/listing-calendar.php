...
$class = '';
if (isset($_GET['tab']) && $_GET['tab'] == 'listing_calendar') {
    $class = 'in active';
}

$post_id = intval($_GET['edit_listing']);
$instances = get_post_meta($post_id, '_listing_calendar_instances', true);

?>
<div id="listing-calendar-tab" class="tab-pane fade <?php echo esc_attr($class); ?>">
    <!--step information-->
    <div class="block">

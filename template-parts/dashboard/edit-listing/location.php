...
<div id="location-tab" class="tab-pane fade <?php echo esc_attr($class); ?>">
    ...
    <div class="block-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="aptSuit"> Apt, Suite </label>
                    <input type="text" autocomplete="false" name="aptSuit" class="form-control" value="<?php homey_field_meta('aptSuit'); ?>" id="aptSuit" placeholder="<?php echo esc_attr(homey_option('ad_aptSuit_placeholder')); ?>">
                </div>
            </div>
            <?php } ?>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input class="form-control" autocomplete="false" name="neighborhood" <?php homey_required('area'); ?> value="<?php echo homey_get_taxonomy_title($listing_id, 'listing_area'); ?>" id="area" placeholder="Enter the Area, Community, Estate, or Special Landmark that helps Identify the Area">
                </div>
            </div>
            <?php } ?>

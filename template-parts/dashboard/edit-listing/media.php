...
$approve_video = get_field('approve_video', $listing_data->ID);
?>
            ...
            <div class="col-sm-12 col-xs-12">
                <div class="upload-property-media">
                    <div id="homey_gallery_dragDrop" class="media-drag-drop">
                        ...
                        <h4>
                            Drag and drop the images to customize the gallery order.<br>Click on the star icon to set
                            the featured image<br>
                            <span>(Recommended size 1440 x 900 px)</span>
                        </h4>
                        <button id="select_gallery_images" href="javascript:;" class="btn btn-secondary"><i
                                class="fa fa-cloud-upload"></i>
                            <?php echo esc_attr(homey_option('ad_upload_btn')); ?></button>
                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div>
                                            <?php
                                            if (!empty($video_url)) {
                                                if ('Not Approved' == $approve_video) { ?>
                                                    <p style="font-weight: bold; color: #961515;">Your video violates our policy.
                                                        Please try another.</p>
                                                <?php } elseif ('Approved' == $approve_video) { ?>
                                                    <p style="font-weight: bold; color: #008000;">Your video has been approved.</p>
                                                <?php } else { ?>
                                                    <p style="font-weight: bold; color: #EEB302;">Your video is waiting for
                                                        approval.</p>
                                                <?php }
                                            } ?>
                                        </div>
                                        ...
                                        <input type="text" class="form-control" name="video_url"
                                            ...
                                            placeholder="<?php echo esc_attr(homey_option('ad_video_placeholder')); ?>">
                                        <p style="margin-top: 5px; font-size: 11px;">*Videos may not include profanity or
                                            offensive content. Videos cannot redirect guests to third-party sites or include
                                            personal contact information. Your video will display on your listing page after
                                            getting approved by Backyard Lease team.</p>
                                    </div>

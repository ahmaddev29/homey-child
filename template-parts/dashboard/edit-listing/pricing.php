...
$amenity_price_type = get_field('amenity_price_type', $listing_data->ID);

$first_half_start_hour = get_field('first_half_start_hour', $listing_data->ID);
$first_half_end_hour = get_field('first_half_end_hour', $listing_data->ID);
$second_half_start_hour = get_field('second_half_start_hour', $listing_data->ID);
$second_half_end_hour = get_field('second_half_end_hour', $listing_data->ID);
    ...
    <div class="block-body">
            ...
            <?php if ($hide_fields['night_price'] != 1) { ?>
                <?php if ($homey_booking_type == 'per_day_date') { ?>
                    <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="day_date_price" value="<?php echo esc_attr($day_date_price); ?>"
                                class="form-control" <?php homey_required('night_price'); ?> id="day_date_price"
                ...
                <?php } elseif ($homey_booking_type == 'per_hour') { ?>
                    <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label
                                for="hour_price"><?php echo esc_html__('Weekday Price', 'homey') . homey_req('night_price'); ?></label>
                            <input type="number" name="hour_price" value="<?php echo esc_attr($hour_price); ?>"
                                class="form-control" <?php homey_required('night_price'); ?> id="hour_price"
                                placeholder="<?php echo esc_html__('Enter weekday price', 'homey'); ?>">
                        </div>
                    </div>
                <?php } else { ?>
                    <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="night_price" value="<?php echo esc_attr($night_price); ?>"
                                class="form-control" <?php homey_required('night_price'); ?> id="night_price"
                                placeholder="<?php echo esc_attr($price_plac); ?>">
                        </div>
                    </div>
                <?php } ?>
            <?php } ?>
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="amenity_price_type" class="selectpicker" required id="amenity_price_type"
                        ...
                        <option <?php selected($amenity_price_type, 'price_per_hour'); ?> value="price_per_hour">Price
                            Per Hour</option>
                        <option <?php selected($amenity_price_type, 'price_per_day'); ?> value="price_per_day">Price Per
                            Day</option>
                        <option <?php selected($amenity_price_type, 'price_per_half_day'); ?>
                            value="price_per_half_day">Price Per Half Day</option>
                    </select>
                </div>
            </div>
            ...
            <?php if ($hide_fields['price_postfix'] != 1) { ?>
                <div class="<?php echo esc_attr($postfix_classes); ?>">
                    <div class="form-group">
                        ...
                        <input type="text" name="price_postfix" value="<?php echo esc_attr($price_postfix); ?>"
                            class="form-control" id="price_postfix"
                            placeholder="<?php echo esc_attr(homey_option('ad_price_postfix_plac')); ?>">
                    </div>
                </div>
            <?php } ?>
            -->
            ...
            <?php if ($hide_fields['weekends_price'] != 1) { ?>
                <?php if ($homey_booking_type == 'per_day_date') { ?>
                    <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="day_date_weekends_price"
                                value="<?php echo esc_attr($weekends_day_date_price); ?>" class="form-control" <?php homey_required('weekends_price'); ?> id="day_date_weekends_price"
                ...
                <?php } elseif ($homey_booking_type == 'per_hour') { ?>
                    <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label
                                for="hourly_weekends_price"><?php echo esc_attr(homey_option('ad_weekends_label')) . homey_req('weekends_price'); ?></label>
                            <input type="number" name="hourly_weekends_price"
                                value="<?php echo esc_attr($hourly_weekends_price); ?>" class="form-control" <?php homey_required('weekends_price'); ?> id="hourly_weekends_price"
                ...
                <?php } elseif ($homey_booking_type == 'per_day_date') { ?>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label
                                for="weekends_price"><?php echo esc_attr(homey_option('ad_weekends_label')) . homey_req('weekends_price'); ?></label>
                            <input type="number" name="weekends_price" value="<?php echo esc_attr($weekends_price); ?>"
                                class="form-control" <?php homey_required('weekends_price'); ?> id="weekends_price"
                ...
                <?php } elseif ($homey_booking_type == 'per_day') { ?>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label
                                for="weekends_price"><?php echo esc_attr(homey_option('ad_weekends_label')) . homey_req('weekends_price'); ?></label>
                            <input type="text" name="weekends_price" value="<?php echo esc_attr($weekends_price); ?>"
                                class="form-control" <?php homey_required('weekends_price'); ?> id="weekends_price"
                                placeholder="<?php echo esc_attr(homey_option('ad_weekends_plac')); ?>">
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="weekends_days" class="selectpicker" <?php homey_required('weekends_days'); ?>
                            ...
                            <option <?php selected($weekends_days, 'sat_sun'); ?> value="sat_sun">
                                <?php echo esc_attr($homey_local['sat_sun_label']); ?>
                            </option>
                            <option <?php selected($weekends_days, 'fri_sat'); ?> value="fri_sat">
                                <?php echo esc_attr($homey_local['fri_sat_label']); ?>
                            </option>
                            <option <?php selected($weekends_days, 'fri_sat_sun'); ?> value="fri_sat_sun">
                                <?php echo esc_attr($homey_local['fri_sat_sun_label']); ?>
                            </option>
                        </select>
                    </div>
                </div>
                    ...
                    <?php if ($hide_fields['priceWeek'] != 1) { ?>
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="priceWeek" value="<?php echo esc_attr($priceWeek); ?>" class="form-control"
                                    <?php homey_required('priceWeek'); ?> id="priceWeek"
                                    placeholder="<?php echo esc_attr($priceWeekPlac); ?>">
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($hide_fields['priceMonthly'] != 1) { ?>
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <label
                                    for="priceMonthly"><?php echo esc_attr($priceMonthlyLabel) . homey_req('priceMonthly'); ?></label>
                                <input type="text" name="priceMonthly" value="<?php echo esc_attr($priceMonthly); ?>"
                                    class="form-control" <?php homey_required('priceMonthly'); ?> id="priceMonthly"
                                    placeholder="<?php echo esc_attr($priceMonthlyPlac); ?>">
                            </div>
                        </div>
                    <?php } ?>
        ...
        <div id="price_per_hour_div" class="row">
            <div class="col-sm-12 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" name="min_book_hours" <?php homey_required('min_book_days'); ?>
                        value="<?php echo esc_attr($min_book_hours); ?>" class="form-control" id="min_book_hours"
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    <label
                        for="start_hour"><?php echo esc_html__('Start Hour', 'homey') . homey_req('start_hour'); ?></label>
        ...
        <div id="price_per_day_div" class="row" style="display:none;">
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    <label
                        for="checkin_after"><?php echo esc_attr('Day Start Hour', 'homey') . homey_req('checkin_after'); ?></label>
                    <select name="checkin_after" class="selectpicker" <?php homey_required('checkin_after'); ?>
                        id="checkin_after" data-live-search="false"
                        title="<?php echo esc_attr(homey_option('ad_text_select')); ?>">
                        <?php
                        for ($halfhour = $start_hour; $halfhour <= $end_hour; $halfhour = $halfhour + 30 * 60) {
                            echo '<option ' . selected(date('H:i', $halfhour), homey_get_field_meta('checkin_after'), false) . ' value="' . date('H:i', $halfhour) . '">' . date(homey_time_format(), $halfhour) . '</option>';
                        }
                        ?>
                    </select>
                </div>
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="form-group">
                    <label
                        for="checkout_before"><?php echo esc_attr('Day End Hour', 'homey') . homey_req('checkout_before'); ?></label>
                    <select name="checkout_before" class="selectpicker" <?php homey_required('checkout_before'); ?>
                        ...
                        <?php
                        for ($halfhour = $start_hour; $halfhour <= $end_hour; $halfhour = $halfhour + 30 * 60) {
                            echo '<option ' . selected(date('H:i', $halfhour), homey_get_field_meta('checkout_before'), false) . ' value="' . date('H:i', $halfhour) . '">' . date(homey_time_format(), $halfhour) . '</option>';
                        }
                        ?>
                    </select>
                </div>
            ...
            <div class="col-sm-3 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="checkin_first_half_after" class="selectpicker" <?php homey_required('checkin_after'); ?>
                        ...
                        <?php
                        for ($halfhour = $start_hour; $halfhour <= $end_hour; $halfhour = $halfhour + 30 * 60) {
                            echo '<option ' . selected(date('H:i', $halfhour), $first_half_start_hour, false) . ' value="' . date('H:i', $halfhour) . '">' . date(homey_time_format(), $halfhour) . '</option>';
                        }
                        ?>
                    </select>
                </div>
            ...
            <div class="col-sm-3 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="checkout_first_half_before" class="selectpicker" <?php homey_required('checkout_before'); ?>
                        ...
                        <?php
                        for ($halfhour = $start_hour; $halfhour <= $end_hour; $halfhour = $halfhour + 30 * 60) {
                            echo '<option ' . selected(date('H:i', $halfhour), $first_half_end_hour, false) . ' value="' . date('H:i', $halfhour) . '">' . date(homey_time_format(), $halfhour) . '</option>';
                        }
                        ?>
                    </select>
                </div>
            ...
            <div class="col-sm-3 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="checkin_second_half_after" class="selectpicker" <?php homey_required('checkin_after'); ?>
                        ...
                        <?php
                        for ($halfhour = $start_hour; $halfhour <= $end_hour; $halfhour = $halfhour + 30 * 60) {
                            echo '<option ' . selected(date('H:i', $halfhour), $second_half_start_hour, false) . ' value="' . date('H:i', $halfhour) . '">' . date(homey_time_format(), $halfhour) . '</option>';
                        }
                        ?>
                    </select>
                </div>
            ...
            <div class="col-sm-3 col-xs-12">
                <div class="form-group">
                    ...
                    <select name="checkout_second_half_before" class="selectpicker" <?php homey_required('checkout_before'); ?>
                        ...
                        <?php
                        for ($halfhour = $start_hour; $halfhour <= $end_hour; $halfhour = $halfhour + 30 * 60) {
                            echo '<option ' . selected(date('H:i', $halfhour), $second_half_end_hour, false) . ' value="' . date('H:i', $halfhour) . '">' . date(homey_time_format(), $halfhour) . '</option>';
                        }
                        ?>
                    </select>
                </div>
            ...
            <?php if ($hide_fields['allow_additional_guests'] != 1) { ?>
                <div class="col-sm-3 col-xs-6">
                    <div class="form-group">
                        ...
                        <label class="control control--radio radio-tab">
                            <input type="radio" <?php checked($allow_additional_guests, 'yes'); ?>
                                name="allow_additional_guests" value="yes">
                            <span
                                class="control-text"><?php echo esc_html__(esc_attr(homey_option('ad_text_yes')), 'homey'); ?></span>
                            <span class="control__indicator"></span>
                            <span class="radio-tab-inner"></span>
                        </label>
                    </div>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="additional_guests_price"
                            value="<?php echo esc_attr($additional_guests_price); ?>" class="form-control"
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="form-group">
                        ...
                        <input type="number" value="<?php echo esc_attr($num_additional_guests); ?>"
                            name="num_additional_guests" class="form-control" id="num_additional_guests"

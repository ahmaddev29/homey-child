...
$layout_order['listing_calendar'] = 'Listing Calendar';
...
if (!empty($listing_data) && ($listing_data->post_type == 'listing')) {
    ...
    if (($listing_data->post_author == $current_user->ID) || homey_is_admin()) {
        ...
        $cal_class = $info_class = $pricing_class = $media_class = $features_class = $location_class = $bedrooms_class = $services_class = $rules_class = $guided_service_class = $listing_calendar_class = '';
        if (isset($_GET['tab']) && $_GET['tab'] == 'calendar') {
            ...
            $rules_class = 'active';
        } elseif (isset($_GET['tab']) && $_GET['tab'] == 'guided_service') {
            $guided_service_class = 'active';
        } elseif (isset($_GET['tab']) && $_GET['tab'] == 'listing_calendar') {
            $listing_calendar_class = 'active';
        } else {
            $info_class = 'active';
        }
            ...
            <div class="block">
                ...
                <div class="listing-submit-wrap">
                    ...
                    if ($post_status != 'pending' || homey_is_admin()) {
                        ...
                        <!--                        <button title="--><?php //echo esc_attr(ucwords($post_status));
                                                                        ?><!--" disabled="disabled" class="btn btn-dark-grey disabled">--><?php //echo esc_attr($homey_local['update_btn']);
                                                                                                                                            ?><!--</button>-->
                        <button title="<?php echo esc_attr(ucwords($post_status)); ?>" class="btn btn-secondary btn-dark-grey"><?php echo esc_attr($homey_local['update_btn']); ?></button>
                    <?php } ?>
                </div>
            </div>
                    ...
                    ?>
                                ...
                                ?>
                                    <li role="presentation" data-tab="features" class="<?php echo esc_attr($features_class); ?>">
                                        <a href="#additional-questions-tab" aria-controls="additional-questions-tab" role="tab" data-toggle="tab">Additional Questions</a>
                                    </li>
                                <?php
                                    break;
                                ...
                                ?>
                                    <li role="presentation" data-tab="bedrooms" class="<?php echo esc_attr($bedrooms_class); ?>">
                                        <a href="#bedrooms-tab" aria-controls="bedrooms-tab" role="tab" data-toggle="tab">Sleeping Accommodations</a>
                                    </li>
                                <?php
                                    break;
                                ...
                                case 'guided_service':
                                ?>
                                    <li role="presentation" data-tab="guided_service" class="<?php echo esc_attr($guided_service_class); ?>">
                                        <a href="#guided-service-tab" aria-controls="guided-service-tab" role="tab" data-toggle="tab">Guided Service</a>
                                    </li>
                                <?php
                                    break;
                                ...
                                ?>
                                    <li role="presentation" data-tab="listing_calendar" id="listing-calendar-tab-link" class="<?php echo esc_attr($listing_calendar_class); ?>">
                                        <a href="#listing-calendar-tab" aria-controls="listing-calendar-tab" role="tab" data-toggle="tab">Calendar</a>
                                    </li>
                    <?php
                                    break;
                            }
                    ...
                    if ($layout_order) {
                        foreach ($layout_order as $key => $value) {
                            ...
                            switch ($key) {
                                ...
                                case 'guided_service':
                                    get_template_part('template-parts/dashboard/edit-listing/guided-service');
                                    break;
                                ...
                                case 'listing_calendar':
                                    get_template_part('template-parts/dashboard/edit-listing/listing-calendar');
                                    break;
                            }
                        }
                    }

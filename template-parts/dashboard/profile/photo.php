    ...
    <div class="block-body">
        <div class="row">
            ...
            <div style="margin-top: 120px;">
                <p>🚫 Note: Trust and safety is always our main concern. Please be aware that images are monitored and flagged because we DO NOT allow the following content on images:
                    <br>Email addresses, Phone numbers, Web addresses, Social media links, Third party payments, such as:
                    Zelle, Wire, Cashapp, Venmo ...etc. Any and all methods of redirecting users off the Backyard Lease Platform.</br>

        ...
        <div class="upload-view-media item-media-thumb">
            ...
            <div class="item-media-price">
                <span class="item-price">
                    ...
                    <sub><?php echo esc_attr($price_separator); ?><span class="price-postfix"
                            id="price-postfix"><?php echo !empty($price_postfix) ? $price_postfix : 'Hour'; ?></span></sub>
                </span>
            </div>

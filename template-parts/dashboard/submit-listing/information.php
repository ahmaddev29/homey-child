...
?>
<div class="form-step" data-step="information">
  <!--step information-->
  <div class="block">
    ...
    <div class="block-body">
      ...
      <div class="row">
        <?php if ($hide_fields['listing_title'] != 1) { ?>
          <div class="col-sm-12">
            <div class="form-group">
              <label for="listing_title"><?php echo 'Enter a fun and unique title' . homey_req('listing_title'); ?></label>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-xs-12">
          <div class="form-group">
            <label for="sub_cat_type">Subcategory</label>
            <input type="text" class="form-control" name="sub_cat_type" placeholder="Enter Subcategory">
            <p>Help Guests better understand your category. For example: If my Category is Golf. My subcategory may be Driving Range or Putt Putt…etc.</p>
          </div>
        </div>
        ...
        <?php if ($hide_fields['guests'] != 1) { ?>
          <div class="col-sm-6 col-xs-12">
            <div class="form-group">
              <label for="guests"> <?php echo 'Max number of guests' . homey_req('guests'); ?> </label>
              <input type="number" data-input-title="<?php echo 'Max number of guests'; ?>" name="guests" id="guests" <?php homey_required('guests'); ?> class="form-control" placeholder="Enter max number of guests">
            </div>
          </div>
        <?php } ?>

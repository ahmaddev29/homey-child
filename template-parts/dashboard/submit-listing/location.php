    ...
    <div class="block">
        <div class="block-title">
            <div class="block-left">
				...
				<p>Your address will not be public. This will only be shared with a confirmed booking guest.</p>
            </div><!-- block-left -->
        </div>
        <div class="block-body">
            ...
            <div class="row">
                ...
                <?php if ($hide_fields['aptSuit'] != 1) { ?>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="aptSuit"> <?php echo esc_attr('Apt, Suite'); ?> </label>
                            <input type="text" autocomplete="false" name="aptSuit" class="form-control" id="aptSuit" placeholder="<?php echo esc_attr(homey_option('ad_aptSuit_placeholder')); ?>">
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php if ($hide_fields['area'] != 1) { ?>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" autocomplete="false" name="neighborhood" id="area" <?php homey_required('area'); ?> placeholder="Enter the Area, Community, Estate, or Special Landmark that helps Identify the Area">
                        </div>
                    </div>
                <?php } ?>

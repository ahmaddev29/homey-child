...
?>
<header id="homey_nav_sticky_mobile"
    class="header-nav header-mobile hidden-md hidden-lg no-cache-<?php echo strtotime("now"); ?>"
    data-sticky="<?php echo esc_attr($menu_sticky); ?>">
            ...
            <div class="col-xs-3">
                <?php if (homey_is_login_register()) { ?>
                    <div class="user-menu text-right">
                        <button type="button" class="btn btn-mobile-nav user-mobile-nav" data-toggle="collapse"

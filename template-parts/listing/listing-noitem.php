...
$list_lat        = get_post_meta(get_the_ID(), 'homey_geolocation_lat', true);
$list_lng        = get_post_meta(get_the_ID(), 'homey_geolocation_long', true);
$location_search = isset($_GET['location_search']) ? sanitize_text_field($_GET['location_search']) : '';
$parts = explode(",", $location_search);
$desired_location = trim($parts[0]);
        ...
        <div class="media-body item-body clearfix">
            ...
            <div class="item-title-head table-block">
                <div class="title-head-left">
                    ...
                    if (!empty($lat && $lng)) {
                        $distance = haversine_distance_mi($lat, $lng, $list_lat, $list_lng);
                        echo '<span class="item-distance">Distance from ' . $desired_location . ': <b>' . round($distance, 2) . ' miles</b></span>';
                    }
                    ?>
                </div>
            </div>

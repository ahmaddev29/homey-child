                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="dashboard-area"><?php

                            if ( !homey_is_renter() ) : ?>

                                <div class="disclaimer">
                                    <p>Remember, to ensure coverage and the safety of you and your guest(s) always communicate through this platform and messaging system. You may not provide or request any phone number or email address prior to accepting a Guest(s) booking. Our messaging systems are monitored to ensure compliance with our policies. By creating an account and continuing with our messaging system, you have agreed to never redirect, avoid fees, or collect payment(s) of any sort directly from the users on the Backyard Lease platform.</p>
                                </div><?php
                            elseif ( homey_is_renter() ) : ?>
                                <div class="disclaimer">
                                    <p>Remember, to ensure coverage and the safety of you and your guest(s) always communicate through this platform and messaging system. You may not provide or request any phone number or email address prior to a Host accepting your booking. Our messaging systems are monitored to ensure compliance with our policies. By creating an account and continuing with our messaging system, you have agreed to never redirect, avoid fees, or collect payment(s) of any sort directly from the users on the Backyard Lease platform.</p>
                                </div><?php
                            endif;
